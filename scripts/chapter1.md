...
本剧本包含**主线**与**隐忍线**两条路线的内容。主线部分统一承接序章 `A`“同意矫诏”与 `B2`“保持沉默”两种起点；`B2` 不再单列独立第一章，而是以【知情不报】等条件文本并入主线。以 `【若隐忍线】` 标注的段落为隐忍线专属新增内容（包括内心独白与隐藏场景），其余部分为主线与隐忍线共用。进入扶苏即位IF线的玩家请参阅独立剧本，本章不包含该路线内容。
...
*你忽然想起沙丘偏殿里那一瞬的沉默。你本可以开口，却终究什么也没说。如今所有人都在向你叩拜，可你心里最清楚，你这身冕服下面，先裹上的不是威仪，是怯。*
...
*（隐藏数值变化：赵高好感度-1，威望值+1，宗室支持度+1。蒙恬、蒙毅存活。若序章获得【知情不报】，此选项也意味着胡亥第一次在朝堂上真正违逆赵高。）*
...
*（本章无论主线或隐忍线，章末均统一收束至【第二章：《血洗宗室》】，承接文件为 `scripts/chapter2.md`。）*

```mermaid
flowchart TD
    subgraph 序章分支
        S_MAIN[序章·主线<br>选项A/B2]
        S_B12[序章·B1-2<br>告发失败回落主线]
