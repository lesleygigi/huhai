...
*（隐藏数值变化：扶苏好感度-2。齐王高好感度+2，赵王将闾好感度+2，诸王好感度+2。获得关键标记【朝堂直谏】。）*
...
*（隐藏数值变化：扶苏好感度不变。齐王高好感度-1，赵王将闾好感度-1。获得关键标记【朝堂中立】。）*
...
*（隐藏数值变化：扶苏好感度+2。齐王高好感度-3，赵王将闾好感度-2，诸王好感度-3。获得关键标记【朝堂驳斥】。）*
...
*（隐藏数值变化：扶苏好感度+1。诸王好感度+2。获得关键标记【劝放权】。）*
...
*（隐藏数值变化：扶苏好感度+3。权谋值+2。获得关键标记【推恩之策】。）*
...
**子婴**：“殿下想好了？此事一旦呈报，陛下必然追问消息来源。殿下如何解释自己在关东有耳目？”

**胡亥**：“如实解释。臣弟在蜀，为自保，曾命人留意关东动向。无意中发现了赵高的踪迹。”

*你顿了顿。*

**胡亥**：“陛下信不信，是他的事。但赵高是所有人的敌人。我不能让他继续在暗处织网。”
...
**子婴**：“上策——返蜀，以证清白。这封信，与前两封一样，极可能是赵高的挑拨。殿下若不敢回去，便正中其下怀。殿下回去，哪怕真有郡守在等着软禁殿下，至少殿下没有辜负陛下的信任。陛下若还对殿下有一分兄弟之情，便不会赶尽杀绝。”

*他伸出第二根手指。*

**子婴**：“中策——滞留咸阳，静观其变。殿下可以染疾为由，暂留咸阳数日。咸阳即将发生的事，殿下避不开，但至少能看清楚——到底是谁在织网，到底是谁想置殿下于死地。”

*他伸出第三根手指。*

**子婴**：“下策——秘密离京，返回巴蜀，整军备战。殿下在巴蜀已有根基，若回去整军经武，进可争天下，退可守一方。但此策一旦施行，殿下与陛下，便再无转圜余地。”
...
*（隐藏数值变化：扶苏好感度+2。恐惧值-1。获得关键标记【返蜀证清白】。若此前未通过场景六密报获得【赵高落网】，则【赵高在逃】标记确认。）*
...
*（隐藏数值变化：扶苏好感度-3。权谋值+3。蜀地兵力+1。获得关键标记【秘密离京】。）*
...
*（若你在兄弟夜话中选择了“推恩之策”，此处改为——）*

**扶苏**：“命李斯、蒙毅共同草拟《推恩令》。凡封王之子，皆可分封，代代推恩，永为定制。”

*李斯出列领旨，面色复杂。他没有想到，这个被自己视为“分封祸端”的政策，竟被胡亥以“推恩”二字化解了根本矛盾。他看了一眼站在殿中的胡亥——那个曾经在沙丘犹豫的少年，如今已能献出如此老辣的国策。*

*诸王闻言，面色各异。公子高脸色铁青——推恩令一旦施行，他的齐王之位将被子嗣瓜分殆尽。公子将闾若有所思——推恩令虽削弱了封王，但也避免了咸阳与封国的直接冲突，未尝不是一条生路。*
...
| 标记名称     | 获得条件                                     | 影响                                      |
| :----------- | :------------------------------------------- | :---------------------------------------- |
| **赵高在逃** | 未通过场景六密报或场景九追杀获得【赵高落网】 | 第五章隐藏结局“TE·扶苏之殂”的必要触发条件 |
| **赵高落网** | 场景六选择密报扶苏，或场景九选择追杀赵高     | 锁定隐藏结局，确保扶苏存活                |
...
flowchart TD
    subgraph IF线第四章宗室之会
        CH4_START[第四章开局<br>扶苏召十二王入朝] --> S1[场景一：成都蜀王府<br>胡亥接诏]
        S1 --> S2[子婴警告：此去是赴宴或赴死]
        S2 --> S3[场景二：咸阳客馆·朝会前夜]
        ...
        S4[场景三/四：章台殿·宗室大朝会] --> N1{★ 朝堂对答 ★}
        
        N1 -->|A：支持诸王直言进谏| A1[当庭陈述蜀中困境<br>请授诸王实权]
        A1 --> A2([标记：朝堂直谏])
        A2 --> A3[扶苏好感-2<br>诸王好感+2]
        A3 --> A4[扶苏不悦退朝<br>赢得诸王敬重]
        
        N1 -->|B：保持中立不偏不倚| B1[建言详定《郡国职官令》]
        B1 --> B2([标记：朝堂中立])
        B2 --> B3[扶苏好感不变<br>诸王好感-1]
        B3 --> B4[扶苏采纳 命蒙毅草拟]
        
        N1 -->|C：支持扶苏驳斥诸王<br>需扶苏好感≥3| C1[当庭驳斥诸王<br>有事可上书]
        C1 --> C2([标记：朝堂驳斥])
        C2 --> C3[扶苏好感+2<br>诸王好感-3]
        C3 --> C4[扶苏赞赏<br>成为宗室众矢之的]
        
        A4 --> S5
        B4 --> S5
        C4 --> S5
        
        S5[场景五：偏殿·兄弟夜话] --> S5A[扶苏坦言进退两难<br>问胡亥：若你为朕当如何]
        S5A --> N2{★ 兄弟夜话 ★}
        ...
        N2 -->|B：献推恩之策<br>需扶苏好感≥2或权谋≥5| E1[献推恩令<br>封王死后分封诸子]
        E1 --> E2([标记：推恩之策])
        E2 --> E3[扶苏好感+3<br>权谋+2]
        E3 --> E4[扶苏激赏]
        
        N2 -->|C：沉默以对| F1[自称不懂治国之道]
        F1 --> F2([标记：沉默以对])
        F2 --> F3[扶苏好感不变]
        ...
        S6[场景六：咸阳客馆·子婴密报] --> S6A[子婴查实：赵高未死<br>在关东布局]
        S6A --> S6B{是否向扶苏密报？}
        S6B -->|是| S6C([获得标记：赵高落网])
        S6B -->|否| S6D([暂获标记：赵高在逃])
        S6C --> S7
        ...
        S7[场景七：咸阳客馆·齐王夜访] --> S7A[齐王高问胡亥立场<br>胡亥告知赵高未死]
        S7A --> S7B{若第三章选择C：主动同盟}
        S7B -->|是| S7C[齐王高：孤信你]
        S7B -->|否| S8
        S7C --> S8
        
        S8[场景八：关东·赵高布局] --> S8A[赵高命人送第三封密信<br>伪造咸阳软禁密诏]
        S8A --> S9
        
        S9[场景九：咸阳客馆·第三封密信] --> S9A[密信：返蜀即自投罗网]
        S9A --> S9B[子婴献三策]
        S9B --> N3{★ 何去何从 ★}
        
        N3 -->|A：返回巴蜀以证清白| G1[决定返蜀]
        G1 --> G2([标记：返蜀证清白])
        G2 --> G3[扶苏好感+2 恐惧-1]
        G3 --> G4[若此前未获赵高落网<br>则赵高在逃确认]
        
        N3 -->|B：滞留咸阳静观其变| H1[以染疾为由暂留]
        H1 --> H2([标记：滞留咸阳])
        H2 --> H3[权谋+2]
        
        N3 -->|C：秘密离京整军备战<br>需蜀地兵力≥1或权谋≥7| I1[不告而别 连夜出城]
        I1 --> I2([标记：秘密离京])
        ...
        S10[场景十：章台殿·朝会最后一日] --> S10A[扶苏颁布诏令<br>命诸王返封国]
        S10A --> S10B{若献推恩之策}
        S10B -->|是| S10C[李斯蒙毅草拟推恩令<br>李斯面色复杂]
        S10C --> END_CH4
        S10B -->|否| END_CH4
    ...
    style S6C fill:#e6ffe6
    style S6D fill:#ffe6cc
    style I4A fill:#e6ffe6
    style I4B fill:#ffe6cc
