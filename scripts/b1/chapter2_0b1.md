# 《胡亥模拟器》IF线：扶苏即位·第二章·仁君的困境（最终定稿）


## 【评估结论】

经过逐段对比，**原剧本在内容完整性和路线呼应上更优**，主要优势包括：
1. 完整保留了“雍城闭门”与“巴蜀之封”两条路线的日常描写，与第一章选择形成呼应
2. 场景三中巴蜀线胡亥烧信的细节具有文学张力，改动版删除后略显单薄
3. 结尾数值结算表结构清晰，改动版的简洁格式可借鉴

改动版的主要改进在于：统一了部分文字的表述方式，使章节内部风格更一致。

**最终定稿策略**：以原剧本为基础，吸收改动版在文字精炼度上的优点，保留原剧本的双线结构及巴蜀线细节，采用改动版更清晰的数值结算表格式。
...
**蒙毅**：“先帝管得了，因为先帝是千古一帝。陛下是仁君，但陛下不是先帝。李斯的郡县制，是为先帝量身打造的。陛下若全盘继承，只会被这套制度压垮。”
...
赵高笑了。笑声在空旷的牢狱中回荡，像夜枭的鸣叫。

**赵高**：“你家主人是谁？李斯？还是哪一位宗室公子？”

**访客**：“你不需要知道。”

赵高收住笑，盯着铁栏外那张隐藏在兜帽下的脸。
...
*（扶苏好感度+2。子婴好感度+1。获得关键标记【呈送密信】。你选择相信扶苏，这将影响后续兄弟关系的走向。）*
...
*（扶苏好感度-1。权谋值+1。获得关键标记【留存密信】。你选择保留底牌，这将使你在后续变局中拥有更多主动权，但也埋下了兄弟猜忌的隐患。）*
...
*廷尉狱。赵高被秘密提出，押入一辆黑色车驾。车驾驶入夜色，去向不明。*
...
- 扶苏：在分封之争中左右为难，仁君的冠冕愈发沉重。
- 赵高：在狱中暗中布局，已被神秘势力秘密转移。
...
flowchart TD
    subgraph IF线第二章仁君的困境
        CH2_START[第二章开局<br>扶苏即位数月] --> S1[咸阳宫·章台殿<br>分封之争爆发]
        S1 --> S1A[蒙毅力主郡国并行<br>李斯坚决反对]
        S1A --> S1B[扶苏犹豫未决<br>退朝]
        
        S1B --> S2[咸阳宫·偏殿<br>扶苏与蒙毅密谈]
        ...
        S4[廷尉狱<br>赵高与神秘访客] --> S4A[访客传递分封之争情报<br>要求赵高暗中配合]
        S4A --> S4B[赵高应允<br>提出事成后脱身条件]
        S4B --> S5
        
        S5[雍城/巴蜀<br>胡亥收到密信] --> S5A[子婴转交匿名密信]
        S5A --> S5B[密信内容：<br>陛下欲削宗室之权<br>名为封王实为圈禁]
        S5B --> N1{密信的抉择}
        
        N1 -->|A：呈送扶苏| A1[将密信转呈咸阳<br>自证清白 警示陛下]
        A1 --> A2([标记：呈送密信])
        A2 --> A3[扶苏好感+2<br>子婴好感+1<br>权谋+1]
        A3 --> A4[子婴赞：公子长大了]
        
        N1 -->|B：留存密信| B1[将密信留存<br>静观其变]
        B1 --> B2([标记：留存密信])
        B2 --> B3[扶苏好感-1<br>权谋+2]
        ...
        S6[咸阳·朝堂<br>分封之争激化] --> S6A[公子高等宗室<br>联名上书支持分封]
        S6A --> S6B[李斯当庭斥为逼宫<br>提及胡亥沙丘之事]
        S6B --> S6C[扶苏不悦<br>制止李斯]
        
        S6C --> S7[咸阳宫·寝殿<br>扶苏的独白]
        S7 --> S7A[回忆蒙恬：<br>弓不能拉得太满]
        S7A --> S7B[扶苏不知该听李斯还是蒙毅<br>深夜独坐]
        
        S7B --> S8[雍城/巴蜀<br>子婴的告诫]
        S8 --> S8A[子婴分析咸阳局势<br>火药桶已点着]
        S8A --> S8B[子婴：活着，然后等]
        
        S8B --> S9[廷尉狱<br>赵高的棋局]
        S9 --> S9A[赵高在狱中勾画宫城图<br>认为时机已到]
        S9A --> S9B[赵高命狱卒传话：可以开始了]
        S9B --> S9C[赵高被秘密转移<br>去向不明]
