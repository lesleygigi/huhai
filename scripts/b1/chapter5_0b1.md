# 《胡亥模拟器》IF线：扶苏即位·第五章·大秦何往（最终定稿）


## 【评估结论】

经过逐段对比，**改动后的剧本在细节丰富度和情感厚度上更优**，主要改进包括：
1. 新增了“隐藏结局触发判定”场景（场景四），使【赵高在逃/落网】标记的作用更加明确
2. 在HE·仁君之佐、HE·巴蜀王、TE·蜀王的选择三个结局中，补充了章邯命运的详细交代，使角色弧光更加完整
3. 史家评语更加精炼且富有文学张力

原剧本的优势在于结构清晰、篇幅均衡。改动版在此基础上进行了有价值的扩展。

**最终定稿策略**：以改动后的剧本为基础，保留原剧本中“终章·尾声”和“全剧终·史家评语”的完整结构，使第五章与IF线整体风格保持一致。
...
*（达成条件：扶苏好感度≥6 + 子婴好感度≥4 + 获得标记【呈送密信】【返蜀证清白】【表忠助剿】）*
...
章邯在巨鹿之战后，被扶苏调回咸阳，不再领兵。你割据巴蜀后，扶苏曾命章邯率军讨伐。章邯上表力辞，称“臣与蜀王有旧，不忍兵戎相见”。扶苏默然良久，收回了成命。
...
*（达成条件：第四章选择A“返蜀证清白” + 本章选择B“按兵不动” + 在最终节点选择支持扶苏）*
...
你回到了巴蜀。此后的岁月里，你安心做你的蜀王，扶苏安心做他的皇帝。你们每年通一次书信，内容只是问候身体，聊聊收成。你们再也没有见过面。

你常常想起在咸阳客馆的那两个月。窗外下着雪，你不知道明天会怎样。那种感觉，你一辈子都忘不了。

*（史家评语·司马迁：“胡亥滞留咸阳，困于客馆六十余日。窗外兵甲之声，日夜不绝。及乱平，扶苏召见，不过寥寥数语，便遣归蜀。此后二十年，兄弟不复相见。胡亥每岁上表问安，扶苏必批一‘知’字。一字之批，二十年不变。或问：此兄弟耶？此君臣耶？太史公曰：帝王之家，兄弟即君臣。既为君臣，便无情分。”）*
...
*（达成条件：第四章选择A“返蜀证清白” + 本章选择C“暗通齐王” + 诸王同盟成功但最终失败）*
...
扶苏没有子嗣。他死后，咸阳群臣拥立了谁？你不知道。你只知道——大秦，再也回不到从前了。
...
1. **HE·仁君之佐**：胡亥成为扶苏最信任的丞相，辅佐大秦走向盛世。
2. **HE·巴蜀王**：胡亥起兵成功，割据巴蜀，与扶苏分庭抗礼四十年，嬴姓宗庙赖以不绝。

### TE类（True Ending·中立或贴近推演）

3. **TE·蜀王的选择**：胡亥观望成败，最终选择支持扶苏，安度余生，平庸而善终。
4. **TE·咸阳的冬天**：胡亥滞留咸阳，亲历宗室内乱，兄弟之情名存实亡，回到巴蜀后再未相见。
5. **TE·诸王同盟**：胡亥加入诸王同盟，兵败被囚于雍城旧宫，余生软禁。
6. **TE·扶苏之殂**（隐藏结局）：扶苏被赵高死士刺杀，仁君陨落，大秦命运未卜。

### BE类（Bad Ending·胡亥惨死或失败）

7. **BE·兄弟阋墙**：胡亥起兵失败，兵败身死于汉中平原。
...
flowchart TD
    subgraph IF线第五章大秦何往
        CH5_START[第五章开局<br>齐王高起兵清君侧] --> S1[齐地·临淄<br>公子高举兵西进]
        S1 --> S2[咸阳·章台殿<br>扶苏令章邯平叛<br>派使者安抚诸王]
        S2 --> S3[关东·赵高棋局<br>齐王为火种 意在点燃诸王]
        ...
        S5{胡亥第四章状态} 
        S5 -->|A：返蜀证清白| S5A[成都·蜀王府]
        S5 -->|B：滞留咸阳| S5B[咸阳客馆]
        S5 -->|C：秘密离京| S5C[成都·蜀王府 整军备战]
