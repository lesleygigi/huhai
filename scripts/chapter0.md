...
*校订说明：现存史料对“七月丙寅”能否稳定换算为某一具体“初几”存在分歧。为避免伪造精确日期，本稿时间线统一采用“公元前210年，七月，丙寅/次日”格式标注。*
...
*（隐藏数值变化：矫诏密谋成功。恐惧值+2。威望值-1，宗室支持度-1，权谋值-1。获得关键标记【知情不报】。蒙毅后续态度将受影响；此后不再进入独立 `B2` 章节，而是作为主线的初始心理/数值变体继续推进。）*
...
flowchart TD
    ...
    %% ========== 第一章去向 ==========
    M_END -->|序章选择A/B2| MAIN[进入第一章·主线]
    M_END -->|序章选择B1-2| MAIN_B12[进入第一章·B1-2回落主线版]
