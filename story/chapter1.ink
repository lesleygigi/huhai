...
你此刻正跪在灵堂最前列，身后是你的二十余位兄弟姐妹，身前，是那具盛放着父亲尸体的黑色棺椁。
...
- else:
    {flags ? 力保扶苏:
        -> chapter1_fusu_exiled
    - else:
        {flags ? 缓兵之计:
            -> chapter1_fusu_delayed
        - else:
            -> chapter1_fusu_dead
        }
    }
...
上面写的是：扶苏接诏后，本欲自尽。但其幕僚中有死士夜叩营帐，呈上一封密信。信中内容不详。扶苏读信后，弃剑痛哭，最终未死。现已按陛下密旨，押赴巴蜀。蒙恬暂留军中，戴罪守边。
...
赵高：“陛下仁厚。臣已遵旨，改赐死为流放。只是……扶苏在军中素有威望，留其性命，恐为后患。”
...
赵高不会为了一个流放的扶苏和你翻脸。不值得。他的目标是蒙氏，是整个朝廷。
...
你不知道这是好事还是坏事。他若见到咸阳的局势，会怎么做？会揭竿而起，还是隐忍不发？
...
{flags ? 隐忍待发:
蒙氏是将门世家，军中门生故吏遍布天下。如果能把蒙毅暗中保下来，将来便是对抗赵高的重要力量。

但赵高正盯着你，满朝文武正盯着你。你不能表现得太明显。

你得想一个让赵高无法反驳的理由……
}

* [同意赵高，处死蒙恬蒙毅]
    -> chapter1_meng_execute
* [赦免留用]
    -> chapter1_meng_retain
* [贬为庶民]
    -> chapter1_meng_dismiss
...
不是因为你恨他们，是因为你现在还不够强。你保不住他们。

你在心里默念那两个名字。将来有一天，如果你能赢，你要为他们平反。
}

-> chapter1_night_study
...
赵高不会善罢甘休，他一定会再找机会除掉他们。但至少今天，你赢了。

更重要的是，蒙毅抬起头时，你看懂了他眼中的神色。那不是感激，是重新燃起的希望。
...
可你现在还不能自己拿主意。明天赵高会来问你，陛下看完了吗？打算怎么批？

你每天都是这样过的。

但你没有浪费这些奏疏。你在看，你在学。你在心里构建一个属于你自己的大秦。
}
...
冯去疾：（叩首，声音苍老而颤抖，却一字一句，掷地有声）“先帝以法治国，然法非不教而诛。扶苏公子仁孝，蒙氏兄弟忠勇，皆先帝所重。今陛下初即位而诛先帝所重之人，天下人当作何想？”
...
他是少数敢对你说真话的人。但他太直了，直得不适合这座咸阳宫。

你想保他。但你不知道怎么保。

你只能在他的名字旁边，在心里打一个记号，此人可用，但需保护。

-> chapter1_secret_record
- else:
-> chapter1_clan_list
}

=== chapter1_secret_record ===
~ scene_name = "隐藏场景·秘密记录"
# bg: side_hall_candle
# hide: zhao_gao
# show: huhai anxious center
...
你站起身，走到寝殿深处。书架后面，有一道你小时候就发现的暗门。那是父皇留下的密室。
...
赵高：“斩草不除根，春风吹又生。扶苏已除，但他的兄弟们还在。只要有一个活着，陛下的江山，就坐不稳。”
...
你知道他的逻辑，所有流着父皇血脉的人，都有资格坐这把椅子。赵高不能容忍任何潜在的威胁。
...
-> chapter1_ziying_meet
- else:
-> chapter1_result
}

=== chapter1_ziying_meet ===
~ scene_name = "隐藏场景·子婴密会"
# bg: xianyang_palace
# show: huhai anxious center
...
你在宗室名单上看到他的名字时，心中就浮现出一个模糊的念头。公子婴，你的堂叔。在始皇帝二十几个子女中，他是最不起眼的一个。

不争，不抢，不结党，不营私。每日在府中种菜读书，仿佛他不是嬴姓血脉，只是一个普通的富家翁。

但正是这种“不起眼”，让你注意到了他。

能在咸阳这座杀人泥潭里“不起眼”地活到现在的人，一定不简单。

车驾停在公子婴府邸侧门。这是一座偏僻的宅院，门庭冷落，连看门的仆人都在打瞌睡。
...
赵高现在不杀你，是因为他觉得你好控制。但如果有一天，他发现你其实不好控制，发现你一直在忍，一直在暗中积蓄力量，他会怎么做？
...
子婴：“臣在宗室中是最不起眼的人。不起眼的人，反而好做事。陛下若信得过臣，臣愿为陛下暗中联络可用之人。”

子婴：“禁卫中对赵高不满者，蒙氏旧部中被贬黜者，宗室中被赵高威胁者，这些人，散落在咸阳各处，像菜籽一样。”
...
扶苏、蒙氏、冯去疾、宗室、子婴——每一个名字都像一枚棋子，也像一把悬在头顶的刀。
